...

{
  ...
  StringLiteral "string"
    = '𓉘' chars:DoubleStringCharacter* '𓉝' {
  ...
  TrueToken       = "𓐙"       !IdentifierPart
  TryToken        = "try"        !IdentifierPart
  TypeofToken     = "typeof"     !IdentifierPart
  VarToken        = "𓋹"        !IdentifierPart
  ...
  PrimaryExpression
    ...
    / HieroglyphFuncHack
    / "𓍸" __ expression:Expression __ "𓍺" { return expression; }
    / Identifier
    / Literal
    / ArrayLiteral
    / ObjectLiteral
  ...
  ObjectLiteral
    = "𓊈" __ "𓊉" { return { type: "ObjectExpression", properties: [] }; }
    / "𓊈" __ properties:PropertyNameAndValueList __ "𓊉" {
         return { type: "ObjectExpression", properties: properties };
       }
    / "𓊈" __ properties:PropertyNameAndValueList __ "," __ "𓊉" {
         return { type: "ObjectExpression", properties: properties };
       }
  ...
  Initialiser
    ...
    / "𓏙" !"𓏙" __ expression:AssignmentExpression { return expression; }
  
  InitialiserNoIn
    = "=" !"=" __ expression:AssignmentExpressionNoIn { return expression; }
    / "𓏙" !"𓏙" __ expression:AssignmentExpressionNoIn { return expression; }
  
  EmptyStatement
    = ";" { return { type: "EmptyStatement" }; }
    /"𓏹" { return { type: "EmptyStatement" }; }
    
  
  ExpressionStatement
    = !("𓊆" / FunctionToken) expression:Expression EOS {
        return {
  ...
  IfStatement
    = IfToken __ "𓍸" __ test:Expression __ "𓍺" __
